...
const Tx = ({ id, hash }) => {
    ...
    */
    ...
    return (
        <PageContainer title="Dream Hunters | Transaction Hash (Txhash) Details" description="Dream Hunters Scan Transaction Hash (Txhash) Details">
            {/* breadcrumb */}
            <Breadcrumb title="Transaction Details" items={BCrumb} />
            {/* end breadcrumb */}
            <Card>
                {
                    loading && !error ?
